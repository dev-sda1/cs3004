...
//    double SharedVariable = 100;
    double account_a = 1000;
    double account_b = 1000;
    double account_c = 1000;

    //Create the shared object in the global scope...
    
    SharedActionState ourSharedActionStateObject = new SharedActionState(account_a, account_b, account_c);
